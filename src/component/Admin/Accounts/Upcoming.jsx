...
const Upcoming = () => {
  ...
  const [emiState, setemiState] = useState({
    ...
    status: storedEmiState.status || "upcoming",
      ...
      <SidebarInset>
        ...
        <main className="flex-1 overflow-auto p-4 sm:p-6 bg-gray-50 dark:bg-gray-900">
          ...
          {loading ? (
            ...
            <div className="mt-6 mx-auto max-w-3xl rounded-lg border border-red-300 bg-red-50 p-4 text-sm text-red-800 shadow-md">
              <strong>Error:</strong>{" "}
              {typeof error === "string"
                ? error
            ...
            // No data fallback, completely centered
